...
# ═══════════════════════════════════════════════════════════════════
#  � WORLD-CLASS AI RESUME ANALYZER
# ═══════════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="✨ AI Resume Analyzer - Professional Edition",
    page_icon="🚀",
    layout="wide",
...
# ═══════════════════════════════════════════════════════════════════
    ...
    if st.button("🧪 Try Demo Analysis"):
        st.balloons()
        st.success("🎉 Demo feature coming soon!")

def extract_experience_level(text):
    # Try to extract from explicit numbers
    match = re.search(r'\d{1,2}[-\s]year[s]?|(\d{1,2})\s?year[s]?\s?of\s?experience', text)
    if match:
